<x-livewire-tables-v1::bs5.table
...
>
    <x-slot name="head">
        @if ($reordering)
            <x-livewire-tables-v1::bs5.table.heading />
        @endif
    ...
    @if ($secondaryHeader)
        <x-slot name="customSecondaryHead">
            <x-livewire-tables-v1::bs5.table.row
            ...
            >
                @if ($reordering)
                    <x-livewire-tables-v1::bs5.table.cell />
                @endif
    ...
    <x-slot name="body">
        ...
        @include('livewire-tables-v1::bootstrap-5.includes.bulk-select-row')
        ...
        @forelse ($rows as $index => $row)
            ...
            >
                @if ($reordering)
                    <x-livewire-tables-v1::bs5.table.cell wire:sortable.handle>
                ...
                @if ($bulkActionsEnabled && count($this->bulkActions))
                    <x-livewire-tables-v1::bs5.table.cell class="align-middle">
                        <input
                            wire:model="selected"
        ...
        @empty
            <x-livewire-tables-v1::bs5.table.row>
                <x-livewire-tables-v1::bs5.table.cell :colspan="$colspan">
                    @lang($emptyMessage)
                </x-livewire-tables-v1::bs5.table.cell>
            </x-livewire-tables-v1::bs5.table.row>
        @endforelse
    ...
    @if ($customFooter)
        <x-slot name="foot">
            ...
            >
                @if ($reordering)
                    <x-livewire-tables-v1::bs5.table.footer />
                @endif
